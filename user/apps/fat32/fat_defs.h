...
//-----------------------------------------------------------------------------
#define SIGNATURE_POSITION						0x1FE
#define SIGNATURE_VALUE							0xAA55
#define PARTITION1_TYPECODE_LOCATION					0x1C2
#define FAT32_TYPECODE1						 	0x0B
#define FAT32_TYPECODE2						 	0x0C
#define PARTITION1_LBA_BEGIN_LOCATION	 		 		0x1C6
#define PARTITION1_SIZE_LOCATION	 			 	0x1CA
