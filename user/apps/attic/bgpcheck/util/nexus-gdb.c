...
void wait_for_connection(void) {
	...
	activating = 1;
	char localip[20];
	Net_GetMyIP(localip, sizeof(localip));
...
void init_gdb_remote(int port, int activate) {
...
static int debug_gdb_itself = 0;

int getDebugChar(void) {
	if (!activated) wait_for_connection();
