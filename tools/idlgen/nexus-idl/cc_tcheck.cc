...
void TF_serviceDecl::itcheck(Env &env)
{
  env.setLoc(loc);
  decl->tcheck(env, DC_MR_DECL);
}

void TF_syscallDecl::itcheck(Env &env)
{
  env.setLoc(loc);
  decl->tcheck(env, DC_MR_DECL);
}
...
/*
void SyscallDecl::tcheck(Env &env, DeclaratorContext dc) {
}

void ServiceDecl::tcheck(Env &env, DeclaratorContext dc) {
}
*/
void GenericIDL::tcheck(Env &env, DeclaratorContext dc) {
}
