...
void TF_serviceDecl::print(PrintEnv &env)
{
  TreeWalkDebug treeDebug("TF_serviceDecl");
  env.loc = loc;
  decl->print(env);
}
void TF_syscallDecl::print(PrintEnv &env)
{
  TreeWalkDebug treeDebug("TF_syscallDecl");
  env.loc = loc;
  decl->print(env);
}
...
#if 0
void ServiceDecl::print(PrintEnv &env)
{
  *env.out << "service " << name << "{\n";
  bool first_time = true;
  FOREACH_ASTLIST_NC(InterfaceMember, decls->list, iter) {
    if(first_time) first_time = false;
    else *env.out << ",\n";
...
void SyscallDecl::print(PrintEnv &env)
{
  *env.out << "service " << name << "{\n";
  bool first_time = true;
  FOREACH_ASTLIST_NC(InterfaceMember, decls->list, iter) {
...
void GenericIDL::print(PrintEnv &env) {
  *env.out << "GenericIDL::print not implemented!\n";
}

void ChannelDecl::print(PrintEnv &env)
{
  *env.out << "channel " << name << "{\n";
  bool first_time = true;
  FOREACH_ASTLIST_NC(InterfaceMember, decls->list, iter) {
    if(first_time) first_time = false;
    else *env.out << ",\n";
...
void IFMR_interface::print(PrintEnv &env) {
  TreeWalkDebug treeDebug("IFMR_interface");
  i->f->print(env);
}

void IFMR_channelDecl::print(PrintEnv &env) {
  TreeWalkDebug treeDebug("IFMR_channelDecl");
  c->print(env);
}

void IFMR_sourceDecls::print(PrintEnv &env) {
  TreeWalkDebug treeDebug("IFMR_sourceDecl ** recursion stopped **");
}

void IFMR_interposeOn::print(PrintEnv &env) {
  TreeWalkDebug treeDebug("IFMR_interposeOn ** recursion stopped **");
}
void IFMR_implements::print(PrintEnv &env) {
  TreeWalkDebug treeDebug("IFMR_implements ** recursion stopped **");
}

void IFMR_interposeCall::print(PrintEnv &env) {
  TreeWalkDebug treeDebug("IFMR_interposeCall ** recursion stopped **");
}

void IFMR_interposeTransfer::print(PrintEnv &env) {
  TreeWalkDebug treeDebug("IFMR_interposeTransfer ** recursion stopped **");
}

void SD_typeSpec::print(PrintEnv &env) {
}

void SD_decl::print(PrintEnv &env) {
  TreeWalkDebug treeDebug("IFMR_decl");
  d->print(env);
}

void SD_func::print(PrintEnv &env) {
  TreeWalkDebug treeDebug("IFMR_func");
  f->print(env);
}

void SD_includeFiles::print(PrintEnv &env) {
  TreeWalkDebug treeDebug("IFMR_includeFileList");
  *env.out << "includefiles {\n";
  bool first_time = true;
...
void IFMR_decon::print(PrintEnv &env) {
  *env.out << "IFMR_decon::print() not implemented!\n";
}

void IncludeFile::print(PrintEnv &env) {
  *env.out << fname;
}
