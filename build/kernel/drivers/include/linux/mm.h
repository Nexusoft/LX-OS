...
#endif /* CONFIG_HIGHMEM || WANT_PAGE_VIRTUAL */
#define phy_page_address(page) __pa(page_address(page))
...
extern unsigned long FASTCALL(__get_free_pages_nexus(unsigned int gfp_mask, unsigned int order));
...
//extern void swapin_readahead(swp_entry_t s);
