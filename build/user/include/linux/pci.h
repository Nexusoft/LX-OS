/*
 *	$Id: pci.h 3368 2007-10-18 19:34:29Z djwill $
 *
...
int pci_register_driver(struct pci_driver *, DeviceType dt);
 ...
 */
static inline int pci_module_init(struct pci_driver *drv, DeviceType dt)
{
  int rc = pci_register_driver(drv, dt);
...
{
#ifdef NEXUS_UDRIVER
  extern void pcicompat_set_drvdata (struct pci_dev *pdev, void *data);
  /* XXX This is stupid.  Nexus does the copy of entire pci structures and
     checks to make sure they are consistent.  We therefore need to
     let Nexus know that this field has been set to something. */
  pcicompat_set_drvdata(pdev, data);
#else
